...
- 💰 可选地填写存款，并在“躺平月支出”和“心愿物品”两种目标中选择一个；仪表盘会显示实时余额、目标进度和还差金额。躺平目标需同时开启退休倒计时，心愿目标不需要。
...
默认值是月薪 8,000 元、每月 22 个工作日、周一至周五 09:00–18:00、午休 12:00–13:00、每秒刷新。薪资可切换为月薪、日薪、时薪或年薪，切换时默认金额会等价换算并取整。退休倒计时和存款默认关闭；躺平目标的“目标每月可花”默认为 3,000 元。
