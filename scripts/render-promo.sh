...
"$FFMPEG" -hide_banner -loglevel error -y \
  ...
  -filter_complex "
    ...
    [share_source]trim=start=12:end=15.1,setpts=PTS-STARTPTS,
      ...
      pad=1920:1080:(ow-iw)/2:190:color=0x0a1211,
      drawtext=fontfile='$FONT':text='想晒进度，一键生成分享卡':fontcolor=0xe4e4e7:fontsize=46:x=(w-text_w)/2:y=55,
      drawtext=fontfile='$FONT':text='默认使用演示数据':fontcolor=0xa1a1aa:fontsize=27:x=(w-text_w)/2:y=113,
      fade=t=in:st=0:d=0.4:color=0x0a1211,fade=t=out:st=2.7:d=0.4:color=0x0a1211[share];
    [2:v]fps=30,settb=AVTB,setpts=PTS-STARTPTS,format=yuv420p,
      ...
      drawtext=fontfile='$FONT':text='github.com/wnma3mz/yuxin':fontcolor=0xa1a1aa:fontsize=30:x=(w-text_w)/2:y=650,
